    ...
    <div className="max-w-[1440px] mx-auto px-12 bg-s py-12">
      <table className="coins-table">
        <thead>
          <tr>
            <th> </th>
            <th className="hidden md:inline t-center ml-4">#</th>
        ...
        <tbody>
          {coins.map((coin) => {
            ...
            return (
              <tr key={coin.id}>
                <td>
                  <button className="hover:text-gold hover:scale-110 duration-300">
                ...
                <td className="t-right">
                  $ {currencyNumber(coin.circulating_supply.toFixed(2))}
                </td>
              </tr>
            );
          })}
