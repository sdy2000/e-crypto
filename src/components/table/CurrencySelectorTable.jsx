...
const CurrencySelectorTable = ({ handleCurrencyChange, currency, title }) => {
  ...
  return (
    <div className="flex flex-col justify-start gap-6">
      ...
      <ul className="flex flex-wrap justify-center gap-y-6 xs:gap-x-3">
        {currency.map((currency) => (
          <li
            ...
            key={currency.id}
            className="flex justify-start items-center gap-3 w-40 xs:w-52 h-16 pl-3 rounded-2xl cursor-pointer hover:bg-t duration-300"
          >
            <img
